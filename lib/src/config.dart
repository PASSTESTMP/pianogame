...
const double keyboardHeight = gameHeight/2;
...
const double sliderWidth = 4 * whiteKeyWidth;
const double sliderHeight = blackKeyWidth;
const double tempoWidth = 4 * whiteKeyWidth;
const double tempoHeight = blackKeyWidth;
const double notesWidth = 4 * whiteKeyWidth;
const double notesHeight = blackKeyWidth;
