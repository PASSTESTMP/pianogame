...
const double defaultWhiteKeyWidth = keyboardWidth / 14 - 1;
const double defaultWhiteKeyHeight = keyboardHeight * 0.8;
const double defaultBlackKeyWidth = defaultWhiteKeyWidth * 0.8;
const double defaultBlackKeyHeight = defaultWhiteKeyHeight * 0.6;
const double sliderWidth = 4 * defaultWhiteKeyWidth;
